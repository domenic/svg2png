    ...
    page.onLoadFinished = function (status) {
        ...
        try {
            ...
            if (options.backgroundColor !== undefined) {
                setSVGBackgroundColor(page, options.backgroundColor);
            }
        } catch (e) {
...
function setSVGBackgroundColor(page, backgroundColor) {
    page.evaluate(function (backgroundColorInside) {
        /* global document: false */
        var el = document.querySelector("svg");

        el.style.backgroundColor = backgroundColorInside;
    }, backgroundColor);
}
